...
const char *fragmentShaderSource = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   vec2 screenSize = vec2(1920, 1080) * 0.666f;\n"
    "   vec2 wpos = gl_FragCoord.xy;\n"
    "   vec2 ovec = (mvec * 0.5 + 0.5) * screenSize;\n"
    "   vec2 opos = (mpos * 0.5 + 0.5) * screenSize;\n"
    "   float total_len = length(ovec);\n"
    "   float len = dot(wpos - opos, normalize(mvec));\n"
    "   int k = int(len / 5);\n"
    "   if (mod(k,2) != 0) discard;\n"
